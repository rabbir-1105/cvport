  ...
  return (
    <section className='grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4' id='contact'>
      <div className='flex flex-col items-center justify-center text-white'>
        ...
        <p className='text-[#ADB7BE] mb-6 text-center'>I'm currently looking for new opportunities. My inbox is always open. Whether you have a question or just want to say hi, I'll try my best to get back to you!</p>
        <div className='flex gap-6'>
          ...
          <a 
            href='https://maychindavong1102@gmail.com' 
            className='bg-[#18191E] hover:bg-[#33353F] p-4 rounded-full transition duration-300'
          >
